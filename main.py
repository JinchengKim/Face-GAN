...
parser.add_argument('--image_path', type = str, default = './test.img', help = 'image that you want to generate')
parser.add_argument('--age', type = int, default = 90, help = 'the target age you want')
...
def main(_):
    ...
    with tf.Session(config=config) as session:
        ...
        if FLAGS.is_train:
            ...
            print '\n\tTesting Mode'
            model.custom_test_single_image(FLAGS.image_path, FLAGS.age)
            # model.custom_test(
